...
const Login = () => {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    // console.log("name---email---password : ",name,email,password,confirmPassword)
    ...
    if(email.length > 0  && password.length > 0 && confirmPassword.length > 0){
      ...
      if(password === confirmPassword){
        ...
        try{
        const response = await axios.post("https://publish-story.onrender.com/api/users/register", formData);
